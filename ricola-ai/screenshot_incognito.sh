...
echo "-------------------------"
PS3='Select TASK: '
options=("DB CONNECT" "BU SQL" "UP SQL" "SCRN BU HOME" "SCRN UP HOME" "SCRN EMAIL" "SCRN VIEWFORM" "SCRN OFDP" "SCRN ICOGNITO" "SCRN OTHER" "SCRN CHROME" "SCRN EDGE" "QUIT")
...
do
    case $opt in
		...
		"SCRN BU HOME")
			...
			if [ -e "./screenshot_buhome_incognito.vbs" ]
				then
					echo "-------------------------"
					echo "STARTING PROCESS BU HOME SCREENSHOT"
					echo "-------------------------"
					cscript //nologo ./screenshot_buhome_incognito.vbs				
        ...
        "SCRN UP HOME")
			...
			if [ -e "./screenshot_uphome_incognito.vbs" ]
				then
					echo "-------------------------"
					echo "STARTING PROCESS UP HOME SCREENSHOT"
					echo "-------------------------"
					cscript //nologo ./screenshot_uphome_incognito.vbs				
									
				else
					echo "-------------------------"
					echo "screenshot_buhome_incognito.vbs is not existing."
					echo "-------------------------"
		...
		"SCRN EMAIL")
           echo "--------------------"
			...
			if [ -e "./screenshot_email_incognito.vbs" ]
				then
					echo "-------------------------"
					echo "STARTING PROCESS EMAIL SCREENSHOT"
					echo "-------------------------"
					cscript //nologo ./screenshot_email_incognito.vbs				
									
				else
					echo "-------------------------"
					echo "screenshot_email_incognito.vbs is not existing."
					echo "-------------------------"
		...
		"SCRN VIEWFORM")
			...
			if [ -e "./screenshot_viewform_incognito.vbs" ]
				then
					echo "-------------------------"
					echo "STARTING PROCESS VIEWFORM SCREENSHOT"
					echo "-------------------------"
					cscript //nologo ./screenshot_viewform_incognito.vbs				
									
				else
					echo "-------------------------"
					echo "screenshot_viewform_incognito.vbs is not existing."
					echo "-------------------------"
		...
		"SCRN OFDP")
			...
			if [ -e "./screenshot_ofdp_incognito.vbs" ]
				then
					echo "-------------------------"
					echo "STARTING PROCESS OFDP SCREENSHOT"
					echo "-------------------------"
					cscript //nologo ./screenshot_ofdp_incognito.vbs				
									
				else
					echo "-------------------------"
					echo "screenshot_ofdp_incognito.vbs is not existing."
					echo "-------------------------"
