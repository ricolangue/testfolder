			...
			if [ -e "./db_link2.vbs" ]
				then
					...
					then
						...
						#mouse_click
						cscript //nologo "../../../../../textReplace.vbs" "m_x" "726" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "m_y" "332" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "db_x" "64" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "db_y" "231" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "exp_x" "654" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "exp_y" "127" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "c_x" "1310" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
						cscript //nologo "../../../../../textReplace.vbs" "c_y" "488" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/db_link2.vbs
