...
blog_guide="blog_guide.txt"
if [ -e "./template/$blog_guide" ]
then
	cp ./template/$custom_blog_guide ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$blog_guide
	start notepad.exe ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$blog_guide
