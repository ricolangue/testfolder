...
tempFolder="LOGIN-FUNCTIONALITY"
...
echo "====================="
echo "FOR SINGLE LOGIN"
echo "====================="

#page_title
read -p "Enter page tile 1:" page_title 
while [[ "${page_title}" == "" ]] ; do
   read -p "Enter page tile 1:" page_title 
done
cscript //nologo "textReplace.vbs" "page_title" "$page_title" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name

#page_link
read -p "Enter page link 1:" page_link 
while [[ "${page_link}" == "" ]] ; do
   read -p "Enter page link 1:" page_link 
done
cscript //nologo "textReplace.vbs" "page_link" "$page_link" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name

#_username1
read -p "Enter username 1:" _username 
while [[ "${_username}" == "" ]] ; do
   read -p "Enter username 1:" _username 
done
...
#_password1
read -p "Enter password 1:" _password 
while [[ "${_password}" == "" ]] ; do
   read -p "Enter password 1:" _password 
done
...
cscript //nologo "textReplace.vbs" "page_title2" "$page_title2" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
...
cscript //nologo "textReplace.vbs" "page_link2" "$page_link2" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
...
cscript //nologo "textReplace.vbs" "_username2" "$_username2" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
...
cscript //nologo "textReplace.vbs" "_password2" "$_password2" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
