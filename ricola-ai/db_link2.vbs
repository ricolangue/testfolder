...
WScript.Sleep 8000
Set objMouse = CreateObject("WScript.Shell")
WshShell.Run "cmd.exe /c nircmd setcursor db_xy", 0, True  
' Wait for a moment  
WScript.Sleep 5000 ' Wait for 1 second  
' Simulate left mouse click  
WshShell.Run "cmd.exe /c nircmd sendmouse left click", 0, True
'CLICK EXPORT 
WScript.Sleep 5000
Set objMouse = CreateObject("WScript.Shell")
WshShell.Run "cmd.exe /c nircmd setcursor exp_xy", 0, True  
' Wait for a moment  
WScript.Sleep 3000 ' Wait for 1 second  
' Simulate left mouse click  
WshShell.Run "cmd.exe /c nircmd sendmouse left click", 0, True
'CLICK GO 
WScript.Sleep 2000
Set objMouse = CreateObject("WScript.Shell")
WshShell.Run "cmd.exe /c nircmd setcursor c_xy", 0, True  
' Wait for a moment  
WScript.Sleep 1000 ' Wait for 1 second  
' Simulate left mouse click  
WshShell.Run "cmd.exe /c nircmd sendmouse left click", 0, True
