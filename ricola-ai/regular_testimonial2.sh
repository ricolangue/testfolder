...
tempFolder="REGULAR-TESTIMONIAL"
...
then
	...
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Required_Before.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\Testimonial_Required_Before' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Required_Before.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_w_waiting_moderation_and_required.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\Testimonial_w_waiting_moderation_and_required' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_w_waiting_moderation_and_required.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/WP_dashboard_Comment_section_for_approve.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\WP_dashboard_Comment_section_for_approve' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/WP_dashboard_Comment_section_for_approve.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Page_w_approved_and_required_admin.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\Testimonial_Page_w_approved_and_required_admin' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Page_w_approved_and_required_admin.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Page_w_approved_and_required.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\Testimonial_Page_w_approved_and_required' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Testimonial_Page_w_approved_and_required.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Mobile_Testimonial_Page_360.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\Mobile_Testimonial_Page_360' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/Mobile_Testimonial_Page_360.vbs
	
	cp ./screenshot.vbs ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/HomePage_w_Testimonial.vbs
	cscript //nologo "textReplace.vbs" "_screenshot" ":screenshot '"$scrn_directory"\HomePage_w_Testimonial' --fullpage" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/HomePage_w_Testimonial.vbs
...
regular_testimonial_guide="regular_testimonial_guide.txt"
if [ -e "./template/$regular_testimonial_guide" ]
then
	cp ./template/$regular_testimonial_guide ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$regular_testimonial_guide
	start notepad.exe ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$regular_testimonial_guide
...
echo "TO QUEUE EMAIL"
echo "--------------------------"
read -p "Enter to_queue email:" to_queue 
while [[ "${cc_email}" == "" ]] ; do
   read -p "Enter to_queue email:" to_queue 
done
#sed -i -e "s/cc_email/${cc_email}/g" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
