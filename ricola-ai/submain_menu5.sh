...
echo "-------------------------"
PS3='Select TASK: '
options=("DB CONNECT" "BU SQL" "UP SQL" "SCRN BU HOME" "SCRN UP HOME" "SCRN EMAIL" "SCRN VIEWFORM" "SCRN OFDP" "SCRN ICOGNITO" "SCRN NEW" "SCRN CHROME" "SCRN EDGE" "GIT" "DB CON2" "OPEN FOLDER" "QUIT")
...
do 
    case $opt in
		...
		"GIT ADD ALL FILES BU")
			...
			includesA=./bu/includes
			bannerA=./bu/banner.php 
			headA=./bu/head.php 
			bottomA=./bu/bottom.php
			footerA=./bu/footer.php 
			middleA=./bu/middle.php 
			functionA=./bu/functions.php 
			loopageA=./bu/loop-page.php 
			pluginsA=./bu/plugins.js
			pluginsminA=./bu/plugins.min.js
			styleA=./bu/style.css
			styleminA=./bu/style.min.css
			commentTemplateA=./bu/comment-template.php
			...
			then
				...
				cd ../
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 3805]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
						...
						cscript //nologo ./textReplace.vbs "" "$scrn_path\\$scrn_windowA" ./$client_file_path2/screenshot_git.vbsscrn_wfile_path
						...
						then
							...
							echo "./screenshot_git.vbs not found "
				...
				then
					...
					my_dir="$(<./mydirectory.txt)"
						file_path1=$my_dir\\data-main\\$client_web
						scrn_directory=$my_dir"\config\scrn_directory.txt"
						
						if [ -e "./getString3.vbs" ]
						then
							echo "getstring3.vbs is existing"
							#cd $client_file_path2
							cp -rf ./getString3.vbs ./config/scrn_directory.vbs
							cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/scrn_directory.vbs
							cscript //nologo "./textReplace.vbs" "search_string" "scrn_directory" ./config/scrn_directory.vbs
							cscript //nologo "./textReplace.vbs" "file_path2" "$scrn_directory" ./config/scrn_directory.vbs
							cscript //nologo ./config/scrn_directory.vbs
							#db_name 
						else 
							echo ""
						fi 
						cd config 						
						screenshot_path="$(<./scrn_directory.txt)"
						cd ../
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 3882]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
						scrn_path="$(<./$client_file_path2/scrn_wfile_path.txt)"
						cscript //nologo ./textReplace.vbs "scrn_wfile_path" "$scrn_path\\$scrn_windowA" ./$client_file_path2/screenshot_git.vbs
			...
			then
				...
				cd ../
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 4014]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
				...
				then
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 4091]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
						scrn_path="$(<./$client_file_path2/scrn_wfile_path.txt)"
						cscript //nologo ./textReplace.vbs "scrn_wfile_path" "$scrn_path\\$scrn_windowA" ./$client_file_path2/screenshot_git.vbs
			...
			then
				...
				cd ../
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 4258]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
						...
						cscript //nologo ./textReplace.vbs "scrn_wfile_path" "$scrn_path\\$scrn_windowA" ./$client_file_path2/screenshot_git.vbs
						#go to folder after copying screenshot file 
						cd $client_file_path2
						cd $git_dir_path
				...
				then
					...
					then
						...
						echo "screenshot_window.vbs is already existing [line: 4335]"
						cp ./screenshot_window.vbs ./$client_file_path2/screenshot_git.vbs
						cscript //nologo ./textReplace.vbs "window_title" "$window_title" ./$client_file_path2/screenshot_git.vbs
						scrn_path="$(<./$client_file_path2/scrn_wfile_path.txt)"
						cscript //nologo ./textReplace.vbs "scrn_wfile_path" "$scrn_path\\$scrn_windowA" ./$client_file_path2/screenshot_git.vbs
...
do
    case $opt in
		...
		"DB ADMINER")
			...
			my_dir="$(<./mydirectory.txt)"
			file_path1=$my_dir\\data-main\\$client_web
			searchDblink=$my_dir"\config\searchDblink.txt"
			searchDbserver=$my_dir"\config\searchDbserver.txt"
			searchDbname=$my_dir"\config\searchDbname.txt"
			searchDbusername=$my_dir"\config\searchDbusername.txt"
			searchDbpassword=$my_dir"\config\searchDbpassword.txt"
						
			if [ -e "./getString3.vbs" ]
			then
				echo "getstring3.vbs is existing"
				#cd $client_file_path2
				cp -rf ./getString3.vbs ./config/searchDblink.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchDblink.vbs
				cscript //nologo "./textReplace.vbs" "search_string" "db_link" ./config/searchDblink.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchDblink" ./config/searchDblink.vbs
				cscript //nologo ./config/searchDblink.vbs
				#db_name 
				cp -rf ./getString3.vbs ./config/searchDbname.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchDbname.vbs
				cscript //nologo "./textReplace.vbs" "search_string" "db_name" ./config/searchDbname.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchDbname" ./config/searchDbname.vbs
				cscript //nologo ./config/searchDbname.vbs
				#db_name 
				cp -rf ./getString3.vbs ./config/searchDbserver.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchDbserver.vbs
				cscript //nologo "./textReplace.vbs" "search_string" "localhost" ./config/searchDbserver.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchDbserver" ./config/searchDbserver.vbs
				cscript //nologo ./config/searchDbserver.vbs
				#db_username
				cp -rf ./getString3.vbs ./config/searchDbusername.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchDbusername.vbs
				cscript //nologo "./textReplace.vbs" "search_string" "db_username" ./config/searchDbusername.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchDbusername" ./config/searchDbusername.vbs
				cscript //nologo ./config/searchDbusername.vbs
				#db_password
				cp -rf ./getString3.vbs ./config/searchDbpassword.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchDbpassword.vbs 
				cscript //nologo "./textReplace.vbs" "search_string" "db_password" ./config/searchDbpassword.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchDbpassword" ./config/searchDbpassword.vbs
				cscript //nologo ./config/searchDbpassword.vbs
			...
			db_link="$(<./config/searchDblink.txt)"
			...
			echo "Get db_name"
			db_name="$(<./config/searchDbname.txt)"
			...
			cscript //nologo "./textReplace.vbs" "$db_name" "db_name" ./$client_file_path/adminer.vbs
			cscript //nologo "./textReplace.vbs" "$db_name" "db_name" ./$client_file_path/phpminiadmin.vbs
			
			echo "Get dbserver"
			db_server="$(<./config/searchDbserver.txt)"
			cscript //nologo "./textReplace.vbs" "$db_server" "localhost" ./$client_file_path/db_link.vbs
			cscript //nologo "./textReplace.vbs" "$db_server" "localhost" ./$client_file_path/db_link2.vbs
			cscript //nologo "./textReplace.vbs" "$db_server" "localhost" ./$client_file_path/adminer.vbs
			cscript //nologo "./textReplace.vbs" "$db_server" "localhost" ./$client_file_path/phpminiadmin.vbs
			
			echo "Get db_username"
			db_username="$(<./config/searchDbusername.txt)"
			...
			cscript //nologo "./textReplace.vbs" "$db_username" "db_username" ./$client_file_path/adminer.vbs
			cscript //nologo "./textReplace.vbs" "$db_username" "db_username" ./$client_file_path/phpminiadmin.vbs
			
			echo "Get db_password"
			db_password="$(<./config/searchDbpassword.txt)"
			...
			cscript //nologo "./textReplace.vbs" "$db_password" "db_password" ./$client_file_path/adminer.vbs
			cscript //nologo "./textReplace.vbs" "$db_password" "db_password" ./$client_file_path/phpminiadmin.vbs
			...
			echo "$db_link" > ./config/searchDblink.txt
			...
			echo "$db_name" > ./config/searchDbname.txt
			...
			#db_name replacement
			cscript //nologo "./textReplace.vbs" "localhost" "$db_server" ./$client_file_path/db_link.vbs
			cscript //nologo "./textReplace.vbs" "localhost" "$db_server" ./$client_file_path/db_link2.vbs
			cscript //nologo "./textReplace.vbs" "localhost" "$db_server" ./$client_file_path/adminer.vbs
			cscript //nologo "./textReplace.vbs" "localhost" "$db_server" ./$client_file_path/phpminiadmin.vbs
			...
			echo "$db_username" > ./config/searchDbusername.txt
			...
			echo "$db_password" > ./config/searchDbpassword.txt
			...
			searchftphostname=$my_dir"\config\searchftphostname.txt"
			searchftpusername=$my_dir"\config\searchftpusername.txt"
			searchftppassword=$my_dir"\config\searchftppassword.txt"
			searchftpport=$my_dir"\config\searchftpport.txt"
			...
			then
				...
				#ftp_hostname
				cp -rf ./getString3.vbs ./config/searchftphostname.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchftphostname.vbs
				cscript //nologo "./textReplace.vbs" "search_string" "ftp_hostname" ./config/searchftphostname.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchftphostname" ./config/searchftphostname.vbs
				cscript //nologo ./config/searchftphostname.vbs
				#ftp_username
				cp -rf ./getString3.vbs ./config/searchftpusername.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchftpusername.vbs 
				cscript //nologo "./textReplace.vbs" "search_string" "ftp_username" ./config/searchftpusername.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchftpusername" ./config/searchftpusername.vbs
				cscript //nologo ./config/searchftpusername.vbs
				#ftp_password
				cp -rf ./getString3.vbs ./config/searchftppassword.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchftppassword.vbs 
				cscript //nologo "./textReplace.vbs" "search_string" "ftp_password" ./config/searchftppassword.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchftppassword" ./config/searchftppassword.vbs
				cscript //nologo ./config/searchftppassword.vbs
				#ftp_port
				cp -rf ./getString3.vbs ./config/searchftpport.vbs
				cscript //nologo "./textReplace.vbs" "file_path1" "$file_path1" ./config/searchftpport.vbs 
				cscript //nologo "./textReplace.vbs" "search_string" "21" ./config/searchftpport.vbs
				cscript //nologo "./textReplace.vbs" "file_path2" "$searchftpport" ./config/searchftpport.vbs
				cscript //nologo ./config/searchftpport.vbs				
			...
			echo "$ftp_hostname" > ./config/searchftphostname.txt
			...
			echo "$ftp_username" > ./config/searchftpusername.txt
			...
			echo "$ftp_password" > ./config/searchftppassword.txt
			...
			echo "$ftp_port" > ./config/searchftpport.txt
			SEARCH_ftp_port="ftp_port="  
			NEW_ftp_port="ftp_port=$ftp_port"  

			if grep -q "$SEARCH_ftp_port" "$FILE"; then  
				sed -i "s|$SEARCH_ftp_port.*|$NEW_ftp_port|" "$FILE"  
			else  
				echo "$NEW_ftp_port" >> "$FILE"  
			fi
								
			#ftp_password replacement
			cscript //nologo "textReplace.vbs" "21" "$ftp_port" ./$client_file_path/filezilla.vbs
